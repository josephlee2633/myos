...
/** @addtogroup GD32f20x_System_Private_FunctionPrototypes
  * @{
  */
...
/** @addtogroup GD32f20x_System_Private_Functions
  * @{
  */
...
void SystemCoreClockUpdate (void)
{
    ...
    switch (temp)
    {
        ...
        if (pllselect == 0x00)
        {
            ...
            SystemCoreClock = (HSI_VALUE >>SYS_HSI_CLOCK_DIVIDED_2) * pllmf / 2;
        }
        else
        {
            ...
            {   /* HSE clock selected as PREDIV1 clock entry */
                SystemCoreClock = (HSE_VALUE / prediv1factor) * pllmf / 2;          
            }
            else
            {   /* PLL2 clock selected as PREDIV1 clock entry */
                ...
                SystemCoreClock = (((HSE_VALUE / prediv2factor) * pll2mf) / prediv1factor) * pllmf / 2;                         
            }
        }
        break;
...
static void SetSysClockTo120(void)
{
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    /* PLL2 configuration: PLL2CLK = (HSE / 1) * 9 = 72 MHz */
    /* PREDIV1 configuration: PREDIV1CLK = PLL2 / 6 = 12 MHz */
        
    RCC->GCFGR2 &= (uint32_t)~(RCC_GCFGR2_PREDV2 | RCC_GCFGR2_PLL2MF |
                              RCC_GCFGR2_PREDV1 | RCC_GCFGR2_PREDV1SEL);
    RCC->GCFGR2 |= (uint32_t)( RCC_GCFGR2_PREDV2_DIV1 | RCC_GCFGR2_PLL2MF9 |
                             RCC_GCFGR2_PREDV1SEL_PLL2 | RCC_GCFGR2_PREDV1_DIV6);
