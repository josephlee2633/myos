...
#ifndef __GD32F20X_CAN_H
#define __GD32F20X_CAN_H
...
typedef struct
{
    ...
    uint8_t CAN_FilterNumber;          /*!< Set the which filter to be initialized. It ranges from 0 to 27. */
