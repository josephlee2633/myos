...
#ifndef __GD32F20X_DAC_H
#define __GD32F20X_DAC_H
...
typedef struct
{
    ...
    uint32_t DAC_WaveType;                     /*!< Wave type of the DAC, noise waves or triangle waves.
    ...
    uint32_t DAC_LFSRNoise_AmplitudeTriangle;  /*!< The LFSR mask for noise wave generation or
                                                    the maximum amplitude triangle generation for the DAC.
                                                    This parameter can be a value of @ref DAC_lfsrnoise_amplitudetriangle */
    uint32_t DAC_OutputBuffer;                 /*!< whether the DAC output buffer is enabled or disabled.
...
#define DAC_TRIGGER_T4_TRGO             ((uint32_t)0x0000002C) /*!< TIMER4 TRGO */
#define DAC_TRIGGER_T5_TRGO             ((uint32_t)0x0000001C) /*!< TIMER5 TRGO */
#define DAC_TRIGGER_T6_TRGO             ((uint32_t)0x00000004) /*!< TIMER6 TRGO */
#define DAC_TRIGGER_T7_TRGO             ((uint32_t)0x00000014) /*!< TIMER7 TRGO */
#define DAC_TRIGGER_T8_TRGO             ((uint32_t)0x0000000C) /*!< TIMER8 TRGO */
...
/** @defgroup DAC_selection
  * @{
  */
#define DAC1                            ((uint32_t)0x00000000)
#define DAC2                            ((uint32_t)0x00000010)
