...
/** @defgroup DCI_interrupt_sources 
  * @{
  */ 
#define DCI_INT_EFM                               ((uint16_t)0x0001)
#define DCI_INT_OVRM                              ((uint16_t)0x0002)
#define DCI_INT_ESEM                              ((uint16_t)0x0004)
#define DCI_INT_VSM                               ((uint16_t)0x0008)
...
#define DCI_FLAG_EFF                              ((uint16_t)0x0001)
#define DCI_FLAG_OVRF                             ((uint16_t)0x0004)
#define DCI_FLAG_ESEF                             ((uint16_t)0x0002)
#define DCI_FLAG_VSF                              ((uint16_t)0x0008)
...
#define DCI_FLAG_EFMF                             ((uint16_t)0x1001)
#define DCI_FLAG_OVRMF                            ((uint16_t)0x1004)
#define DCI_FLAG_ESEMF                            ((uint16_t)0x1002)
#define DCI_FLAG_VSMF                             ((uint16_t)0x1008)
