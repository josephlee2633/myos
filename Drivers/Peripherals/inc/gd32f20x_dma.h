...
#ifndef __GD32F20X_DMA_H
#define __GD32F20X_DMA_H
...
/** @defgroup DMA_Full_Data_transfer_definition 
  * @{
  */
#define DMA_FULLDATATRANSFE_DISABLE        ((uint32_t)0x00000000)
#define DMA_FULLDATATRANSFE_ENABLE          DMA_ACR_FD_MODE6
