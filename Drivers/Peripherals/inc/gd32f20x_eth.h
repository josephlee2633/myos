...
/** @defgroup ETH_MAC_Flags 
  * @{
  */ 
#define ETH_MAC_FLAG_TMST                               ((uint32_t)0x00000200)  /*!< Time stamp trigger flag (on MAC) */
...
/** @defgroup ETH_MAC_Interrupts 
  * @{
  */ 
#define ETH_MAC_INT_TMST                                 ((uint32_t)0x00000200)  /*!< Time stamp trigger interrupt (on MAC) */
