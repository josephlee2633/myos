...
#ifndef __GD32F20X_SDIO_H
#define __GD32F20X_SDIO_H
...
typedef struct
{
    ...
    uint16_t SDIO_ClockDiv;              /*!< Configure the clock frequency prescaler of the SDIO controller.
                                                        This parameter can be a value between 0x000 and 0x1FF. */                                           
} SDIO_InitPara;
