...
#define DMA2_Channel6_INT_Mask    ((uint32_t)(DMA_IFR_GIF6 | DMA_IFR_TCIF6 | DMA_IFR_HTIF6 | DMA_IFR_ERRIF6))
#define DMA2_Channel7_INT_Mask    ((uint32_t)(DMA_IFR_GIF7 | DMA_IFR_TCIF7 | DMA_IFR_HTIF7 | DMA_IFR_ERRIF7))
...
/**
  ...
  * @param  DMAy_Channelx: where y:[1,2] to select the DMA , x:[1,7] to select the DMA Channel.
  * @retval None
  */
void DMA_DeInit(DMA_Channel_TypeDef* DMAy_Channelx)
{
    ...
    else if (DMAy_Channelx == DMA2_CHANNEL6)
    {
        ...
        DMA2->ICR |= DMA2_Channel6_INT_Mask;
    }
    else
    { 
    if (DMAy_Channelx == DMA2_CHANNEL7)
    {
        /* Reset interrupt pending bits for DMA2 Channel7 */
        DMA2->ICR |= DMA2_Channel7_INT_Mask;
    }
    }
}
...
/**
  ...
  *     @arg DMA2_INT_GL6: DMA2 Channel6 global interrupt.
  *     @arg DMA2_INT_TC6: DMA2 Channel6 transfer complete interrupt.
  *     @arg DMA2_INT_HT6: DMA2 Channel6 half transfer interrupt.
  *     @arg DMA2_INT_TE6: DMA2 Channel6 transfer error interrupt.
  *     @arg DMA2_INT_GL7: DMA2 Channel7 global interrupt.
  *     @arg DMA2_INT_TC7: DMA2 Channel7 transfer complete interrupt.
  *     @arg DMA2_INT_HT7: DMA2 Channel7 half transfer interrupt.
  *     @arg DMA2_INT_TE7: DMA2 Channel7 transfer error interrupt.
...
/**
  * @brief  Enable or disable the DMA2 Full_Data transfer mode.
  * @param  NewValue: new state of the DMA2. 
  * @note   This function is not sutiable for DMA1.
  *   This parameter can be: ENABLE or DISABLE.
  * @retval None
  */
void DMA_FullData_Transfer_Config(TypeState NewValue)
{
    if (NewValue != DISABLE)
    {
        /* Enable the DMA2 Full_Data transfer mode */
        DMA2->ACR |= DMA_FULLDATATRANSFE_ENABLE;
    }
    else
    {
        /* Disable the DMA2 Full_Data transfer mode */
        DMA2->ACR |= DMA_FULLDATATRANSFE_DISABLE;
    }
}
/**
  * @}
