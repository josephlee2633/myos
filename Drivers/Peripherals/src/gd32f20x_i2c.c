...
/**
  ...
  * @param  I2Cx: the I2C interface where x can be 1,2 or 3.
  * @retval None.
  */
void I2C_DeInit(I2C_TypeDef* I2Cx)
{
    ...
    else
    {
        ...
        RCC_APB1Periph2Reset_Enable(RCC_APB1PERIPH2_I2C3RST, ENABLE);
        /* Release I2C3 from reset state */
        RCC_APB1Periph2Reset_Enable(RCC_APB1PERIPH2_I2C3RST, DISABLE);
    }
}
