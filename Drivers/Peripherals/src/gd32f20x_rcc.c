...
#define  GCFGR_RESET                                    ((uint32_t)0xE0FF0000)
...
#define  GCFGR_PLLSEL_PLLPREDV_PLLMF_OTGFSPS_RESET      ((uint32_t)0xDF00FFFF)
...
#define  GCIR_INT_FLAG_RESET                           ((uint32_t)0x00FF0000)
...
/* RCC GCFGR3 reset */
#define  GCFGR3_RESET                                   ((uint32_t)0x00000000)

/* RCC GPLLTIR_INT ans FLAG masks */
#define  GPLLTIR_INT_FLAG_RESET                         ((uint32_t)0x00400000)

/* RCC PLLTCFGR reset */
#define  PLLTCFGR_RESET                                 ((uint32_t)0x20003010)
...
void RCC_DeInit(void)
{
    ...
    RCC->GCFGR &= GCFGR_PLLSEL_PLLPREDV_PLLMF_OTGFSPS_RESET;
    ...
    RCC->GCFGR3 =GCFGR3_RESET ;

    /* Disable all interrupts and clear flag bits */
    RCC->GPLLTIR = GPLLTIR_INT_FLAG_RESET;

    /* Reset PLLTCFGR register */
    RCC->PLLTCFGR = PLLTCFGR_RESET;
}
...
/**
  ...
  * @param  None
  * @retval Get the system clock source. 
...
/**
  * @brief  Configure the USB_OTG clock (USB_OTG CLK) or RNG clock.
  * @param  RCC_OTGFSCLK: specify the USB_OTG or RNG clock source. This clock is derived 
  *         from the PLL.
  *   This parameter can be one of the following values:
  *     @arg RCC_OTGCLK_PLL_DIV1_5: USB_OTG or RNG clock = PLL/1.5
  *     @arg RCC_OTGCLK_PLL_DIV1:   USB_OTG or RNG clock = PLL
  *     @arg RCC_OTGCLK_PLL_DIV2:   USB_OTG or RNG clock = PLL/2
  *     @arg RCC_OTGCLK_PLL_DIV2_5: USB-OTG or RNG clock = PLL/2.5      
  * @retval None
  */
...
/**
  * @brief  Configure LSE oscillator drive capability (LSEDRV).
  * @param  RCC_LSEDRV: specify LSE oscillator drive capability.
  *  This parameter can be one of the following values:
  *    @arg RCC_LSEDRV_LOW: specify LSE oscillator lower drive capability  
  *    @arg RCC_LSEDRV_MEDIUM_LOW: specify LSE oscillator medium low drive capability 
  *    @arg RCC_LSEDRV_MEDIUM_HIGH: specify LSE oscillator medium high drive capability
  *    @arg RCC_LSEDRV_HIGH: specify LSE oscillator higher drive capability
  * @retval None
  */
void RCC_LSEDRVConfig(uint32_t RCC_LSEDRV)
{

    /* Reset LSEDRV bits before configuring the LSEDVR */
...
/**
  ...
  * @param  RCC_AHB2Periph: specify the AHB2 peripheral clock.
  *   This parameter can be any combination of the following values:        
  *     @arg RCC_AHB2PERIPH_DCI
  *     @arg RCC_AHB2PERIPH_CAU
  *     @arg RCC_AHB2PERIPH_HAU
...
/**
  * @brief  Enable or disable the APB2 peripheral 2 clock.
  * @param  RCC_APB2Periph2: specify the APB2 peripheral 2 clock.
  *   This parameter can be any combination of the following values:
  *     @arg RCC_APB2PERIPH2_USART6
  *     @arg RCC_APB2PERIPH2_TLDI
  *     @arg RCC_APB2PERIPH2_GPIOH
  *     @arg RCC_APB2PERIPH2_GPIOI
  * @param  NewValue: new state of the peripheral 2 clock.
  *   This parameter can be: ENABLE or DISABLE.
  * @retval None
  */
...
/**
  * @brief  Enable or disable the APB1 peripheral 2 clock.
  * @param  RCC_APB1Periph2: specify the APB1 peripheral 2 clock.
  *   This parameter can be any combination of the following values:
  *     @arg RCC_APB1PERIPH2_I2C3
  *     @arg RCC_APB1PERIPH2_UART7
  *     @arg RCC_APB1PERIPH2_UART8
  * @param  NewState: new state of the specified peripheral 2 clock.
  *   This parameter can be: ENABLE or DISABLE.
  * @retval None
  */
...
/**
  ...
  * @param  RCC_AHB2PeriphRST: specify the AHB2 peripheral to reset.
  *   This parameter can be any combination of the following values:
  *     @arg RCC_AHB2PERIPH_DCIRST 
  *     @arg RCC_AHB2PERIPH_CAURST
  *     @arg RCC_AHB2PERIPH_HAURST
  *     @arg RCC_AHB2PERIPH_RNGRST
  * @param  NewState: new state of the specified peripheral reset.
  *   This parameter can be: ENABLE or DISABLE.
  * @retval None
  */
...
/**
  * @brief  Force or release APB2 peripheral 2 reset.
  * @param  RCC_APB2Periph2RST: specify the APB2 peripheral2 to reset.
  *   This parameter can be any combination of the following values:
  *     @arg RCC_APB2PERIPH2_USART6RST
  *     @arg RCC_APB2PERIPH2_TLDIRST
  *     @arg RCC_APB2PERIPH2_GPIOHRST
  *     @arg RCC_APB2PERIPH2_GPIOIRST
  * @param  NewValue: new state of the peripheral reset.
  *   This parameter can be: ENABLE or DISABLE.
  * @retval None
  */
void RCC_APB2Periph2Reset_Enable(uint32_t RCC_APB2Periph2RST, TypeState NewValue)
{
    ...
    if (NewValue != DISABLE)
    {
        RCC->APB2RCR2 |= RCC_APB2Periph2RST;
    }
    else
    {
        RCC->APB2RCR2 &= ~RCC_APB2Periph2RST;
...
/**
  * @brief  Force or release APB1 peripheral 2 reset.
  * @param  RCC_APB1Periph2RST: specify the APB1 peripheral 2 to reset.
  *   This parameter can be any combination of the following values:
  *     @arg RCC_APB1PERIPH2_I2C3RST
  *     @arg RCC_APB1PERIPH2_UART7RST
  *     @arg RCC_APB1PERIPH2_UART8RST
  * @param  NewValue: new state of the peripheral clock (ENABLE or DISABLE).
  * @retval None
  */
void RCC_APB1Periph2Reset_Enable(uint32_t RCC_APB1Periph2RST, TypeState NewValue)
{
    if (NewValue != DISABLE)
    {
        RCC->APB1RCR2 |= RCC_APB1Periph2RST;
    }
    else
    {
        RCC->APB1RCR2 &= ~RCC_APB1Periph2RST;
...
/**
  ...
  * @param  RCC_CKOUTDIVx: configure the prescaler of the CKOUT.
  *   This parameter can be one of the following values:
  *     @arg RCC_CKOUTDIVx: CKOUT clock is divided by x, x:[1,64].
  * @retval None
  */

void RCC_CKOUTSELConfig(uint32_t RCC_CKOUTSRC, uint32_t RCC_CKOUTDIVx)
{
    uint32_t temp_source = 0;
    uint32_t temp_divide = 0;
 
    temp_source = RCC->GCFGR;
    /* Clear CKOUTSRC[2:0] bits */
    temp_source &= ~(RCC_GCFGR_CKOUTSEL);
    /* Set the RCC_CKOUTSRC */
    temp_source |= RCC_CKOUTSRC;
    /* Store the new value */
    RCC->GCFGR = temp_source;

    temp_divide = RCC->GCFGR3;
    /* Clear CKOUTDIV[5:0] bits */
    temp_divide &= ~(RCC_GCFGR3_CKOUTDIV);
    /* Set the RCC_CKOUTDIV */
    temp_divide |= RCC_CKOUTDIVx;
    /* Store the new value */
    RCC->GCFGR3 = temp_divide;
}
...
/**
  ...
  *     @arg RCC_CKOUT2SRC_SYSCLK: System clock selected
  *     @arg RCC_CKOUT2SRC_HSI: HSI oscillator clock selected
  *     @arg RCC_CKOUT2SRC_HSE: HSE oscillator clock selected
  *     @arg RCC_CKOUT2SRC_PLL2CLK: PLL2 clock selected                     
  *     @arg RCC_CKOUT2SRC_PLLCLK_DIV2: PLL clock divided by 2 selected
  *     @arg RCC_CKOUT2SRC_PLL3CLK: PLL3 clock selected 
  *     @arg RCC_CKOUT2SRC_PLL3CLK_DIV2: PLL3 clock divided by 2 selected   
  *     @arg RCC_CKOUT2SRC_EXT1: External 3-25 MHz oscillator clock selected  
  * @param  RCC_CKOUT2DIVx: configure the prescaler of the CKOUT2.
  *   This parameter can be one of the following values:
  *     @arg RCC_CKOUT2DIVx: CKOUT2 clock is divided by x, x:[1,64].
  * @retval None
  */
...
void RCC_CKOUT2SELConfig(uint32_t RCC_CKOUT2SRC, uint32_t RCC_CKOUT2DIVx)
{
    ...
    temp_source = RCC->GCFGR3;
    /* Clear CKOUTSRC[2:0] bits */
    temp_source &= ~(RCC_GCFGR3_CKOUT2SEL | RCC_GCFGR3_CKOUT2DIV);
    /* Set the RCC_CKOUTSRC */
    temp_source |= (RCC_CKOUT2SRC | RCC_CKOUT2DIVx);
    /* Store the new value */
    RCC->GCFGR3 = temp_source;
...
/**
  ...
  *     @arg RCC_INT_PLLTSTB:  PLLT ready interrupt
...
{  
    ...
    else
    {
        if (NewValue != DISABLE)
        {
            /* Perform Byte access to RCC_GPLLTIR 14 bit to enable the selected interrupts */
            RCC->GPLLTIR |= (RCC_INT<<8);
        }
        else
        {
            /* Perform Byte access to RCC_GPLLTIR 14 bit to disable the selected interrupts */
            RCC->GPLLTIR &= ~(RCC_INT<<8);
        }
    }
...
/**
  ...
  *     @arg RCC_FLAG_PLLTSTB: PLLT clock ready,(only for GD32F20X devices)
...
TypeState RCC_GetBitState(uint8_t RCC_FLAG)
{
    ...
    /* The flag to check is in GPLLTCR register */
    else if (temp == 4)          
    {
        statusreg = RCC->GPLLTCR;
    }
...
/**
  ...
  *     @arg RCC_INT_PLLTSTB: the flag PLLT ready interrupt,(only for GD32F20X devices)
...
{  
    ...
    {
      /* Check the status of the RCC interrupt */
        if ((RCC->GPLLTIR & (RCC_INT & ((uint32_t)0x00000040))) != (uint32_t)RESET)
        {
            return SET;
        }
        else
...
/**
  ...
  *     @arg RCC_INT_PLLTSTB: PLLT ready interrupt, (only for GD32F20X devices)
  * @retval None
  */
...
void RCC_ClearIntBitState(uint32_t RCC_INT)
{
    ...
    {
        /* Perform RCC_GPLLTIR[23:16] bits to clear the selected interrupt bits */
         RCC->GPLLTIR |= (RCC_INT<<16);
    }
}
...
/**
  * @brief  Enable or disable the PLLT clock.    
  * @param  NewValue: new state of the peripheral clock.
  *   This parameter can be: ENABLE or DISABLE.
  * @retval None
  */
void RCC_PLLT_Enable(TypeState NewValue)
{
    if (NewValue != DISABLE)
    {
        RCC->GPLLTCR |= RCC_GPLLTCR_PLLTEN;
    }
    else
    {
        RCC->GPLLTCR &= ~RCC_GPLLTCR_PLLTEN;
...
/**
  * @brief  Configure the PLLT clock (PLLTCLK).
  * @note   The PLLT clock can be changed when PLLT is disabled.
  * @param  RCC_PLLTCLKSource: specify the PLLT clock source.
  *   This parameter can be one of the following values:
  *     @arg RCC_PLLTCLKSOURCE_HSE: HSE selected as PLLT clock
  *     @arg RCC_PLLTCLKSOURCE_HSI: HSI selected as PLLT clock
  * @retval None
  */
void RCC_PLLTCLKConfig(uint32_t RCC_PLLTCLKSource)
{
    ...
    /* Clear PLLSAISRC */
    RCC->PLLTCFGR &= ~RCC_PLLTCFGR_PLLTSEL;
    /* Select the PLLSAL clock source */
    RCC->PLLTCFGR |= RCC_PLLTCLKSource;
...
/**
  ...
  *
  * @note   This function can be used only for GD32F20X devices 
  *        
  * @note   This function must be used only when the PLLT is disabled.
  *             
  * @param  PLLTPS: specify the division factor for PLLT VCO input clock
  *          This parameter must be a number between 2 and 63.
  *            PLLT VCO input clock = PLLT clock/PLLTPS.       
  *
  * @note   You have to set the PLLTPS parameter correctly to ensure that the VCO input
  *         frequency ranges from 1 to 2 MHz. 
  *   
  * @param  PLLTMF: specify the multiplication factor for PLLT VCO output clock
  *          This parameter must be a number between 49 and 432.
  *            PLLT VCO output clock = PLLT VCO input clock * PLLTMF.       
  *   
  * @param  PLLTRPS: specify the division factor for TLDI clock
  *          This parameter must be a number between 2 and 7.
  *            f(PLLT_R) = PLLT VCO output clock/PLLTRPS.       
  *   
  * @retval None
  */
void RCC_PLLTVCOConfig(uint32_t PLLTPS, uint32_t PLLTMF, uint32_t PLLTRPS)
{
    /* Clear PLLTPS, PLLMF, PLLTRPS bits */
    RCC->PLLTCFGR &= ~( RCC_PLLTCFGR_PLLTPS | RCC_PLLTCFGR_PLLTMF | RCC_PLLTCFGR_PLLTRPS);
    /* Select the PLLSAL clock source */    
    RCC->PLLTCFGR |= (PLLTPS | (PLLTMF << 6) | (PLLTRPS << 28));
}

/**
  * @brief  Configure the TLDI clock Divider coming from PLLT.
  * 
  * @note   The LTDC peripheral is only available with GD32F20X Devices.
  *      
  * @note   This function must be called before enabling the PLLT.
  *   
  * @param  RCC_PLLT_TLDIPS_Divx: specify the PLLT_R division factor for TLDI clock .
  *   This parameter can be one of the following values:
  *     @arg RCC_PLLT_TLDIPS_DIV2: TLDI clock = PLLT_R/2
  *     @arg RCC_PLLT_TLDIPS_DIV4: TLDI clock = PLLT_R/4
  *     @arg RCC_PLLT_TLDIPS_DIV8: TLDI clock = PLLT_R/8
  *     @arg RCC_PLLT_TLDIPS_DIV16: TLDI clock = PLLT_R/16
  *          TLDI clock frequency = f(PLLT_R) / RCC_PLLT_TLDIPS_Divx  
  *            
  * @retval None
  */
void RCC_TLDICLKDivConfig(uint32_t RCC_PLLT_TLDIPS_Divx)
{
    ...
    /* Clear TCDIPS[1:0] bits */
    temp &= ~RCC_PLLTCFGR_TLDIPS;
    
    /* Set TCDIPS[1:0] values */
    temp |= RCC_PLLT_TLDIPS_Divx;
