...
/**
  ...
  * @param  SPIx: Select the SPI or the I2S peripheral where x can be 1..3.
  * @retval None
  */
...
/**
  ...
  * @param  SPIx: Select the SPI peripheral where x can be 1..3.
...
/**
  ...
  * @param  SPIx: Select the I2S peripheral  where x can be 2 or 3.
...
/**
  ...
  * @param  SPIx: Select the SPI or I2S peripheral where x can be 1..3.
...
/**
  * @brief  Enable or disable the SPI_IO34 Output.
  * @param  SPIx: Select the SPI peripheral where x is 1.
  * @param  NewValue: ENABLE or DISABLE.
  * @retval None
  */
void QSPI_IO34DRV(SPI_TypeDef* SPIx,TypeState NewValue)
{
    if (NewValue != DISABLE)
    {
        SPIx->SPIQWCR |= SPI_QWCR_IO34_DRV;
    }
    else
    {
        SPIx->SPIQWCR &=~SPI_QWCR_IO34_DRV;  
...
/**
  * @brief  Enable or disable the QSPI.
  * @param  SPIx: Select the SPI peripheral where x is 1.
  * @param  NewValue: ENABLE or DISABLE.
  * @retval None
  */
void QSPI_Enable(SPI_TypeDef* SPIx,TypeState NewValue)
{
    if (NewValue != DISABLE)
    { 
        SPIx->SPIQWCR |= SPI_QWCR_QMOD;
    }
    else
    {
        SPIx->SPIQWCR &=~SPI_QWCR_QMOD;     
...
/**
  * @brief  Enable or disable the QSPI Read Operation.
  * @param  SPIx: Select the SPI peripheral where x is 1.
  * @param  NewValue: ENABLE or DISABLE.
  * @retval None
  */
void QSPI_Read_Enable(SPI_TypeDef* SPIx,TypeState NewValue)
{
    if (NewValue != DISABLE)
    {    
        SPIx->SPIQWCR |=SPI_QWCR_QRD;
    }
    else
    {
        SPIx->SPIQWCR &=~SPI_QWCR_QRD;        
...
/**
  * @brief  Enable or disable the QSPI Write Operation.
  * @param  SPIx: Select the SPI peripheral where x is 1.
  * @param  NewValue: ENABLE or DISABLE.
  * @retval None
  */
void QSPI_Write_Enable(SPI_TypeDef* SPIx,TypeState NewValue)
{
    if (NewValue != DISABLE)
    {    
        SPIx->SPIQWCR &=~SPI_QWCR_QRD; 
